...
mod tests {
	...
	#[test]
	fn should_ignores_numbers_gt_1000() {
		assert_eq!(1001, add_string("1,1000,10002"));
	}
	#[test]
	fn should_support_multi_char_custom_delim() {
		assert_eq!(6, add_string("//[abc]\n1abc2abc3"));
	}
	#[test]
	fn should_support_n_multi_char_custom_delim() {
